...
<title>Datos de Acceso a Pluma</title>
<style type="text/css">
<!--
body {
...
<div class="container">
  ...
  <h1 align="center">Datos de Acceso a Pluma</h1>
  </div>
  <div class="content">
    <h2>Alta de Usuario:</h2>
<p>Sus datos han sido cargados correctamente en la base de datos del sistema. </p>
  ...
  <div class="footer">
    <p align="center">Sistema de Gestión Académica Pluma 2012 ® </p>
    <!-- end .footer --></div>
<!-- end .container --></div>
</body>
</html>